    ...
    <>
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tighter text-orange-600 sm:text-6xl">Sua loja de qualidade <br />{' '}
          ...
          <p className="mt-6 text-lg max-w-prose to-muted-foreground">
            Seja Bem vindo a loja Digital
            sangiogiovba@gmail.com
            sua loja de confianca onde
            voce compra seus produtos
            de qualidade
          </p>
